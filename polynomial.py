...
class Add:
    ...
    def evaluate(self, x_value):
        ...
        o1 = self.p1.evaluate(x_value)
        o2 = self.p2.evaluate(x_value)
        if isinstance(self.p1, (Add, Sub, Mul, Div, X)):
            o1 = o1.evaluate(x_value)
        if isinstance(self.p2, (Add, Sub, Mul, Div, X)):
            o2 = o2.evaluate(x_value)
        return Int(o1 + o2)
